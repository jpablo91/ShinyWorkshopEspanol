...
Objetivos:
  ...
  - Familiarizarse con el entorno de Rstuio y shiny
...
Rstudio es mas que un editor de codigo para R, Rstudio tambien puede ser usado para administrar tus proyectos. Esto tiene varias ventajas por que te ayuda a contener tu trabajo de manera organizada en un directorio con todos los archivos y objetos que crees en tu entorno (environment). Cuando inicias Rstudio por primera vez, se inicia en un projecto vacio, para crear un proyecto haz click en el menu superior derecho de la opcion de los proyectos y selecciona *New Project...*  

<img src="img/Ia_01-NewProj.png" style="width:50%" align="center">

Despues te dara la opcion de crear un nuevo proyecto en un nuevo directorio, en un directorio existente o version control. Para hoy seleccionaremos la opcion de crear un nuevo proyecto en un nuevo directorio (*New directory*)  
...
Hay multiples maneras de inciar una shiny app, en general la aplicacion shiny consta de 2 partes: una interfaz de usuario (ui) y un servidor (server). Primero hay que asegurarnos de tener instalada la libreria de shiny.
